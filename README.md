...
- 🌊 **淹水風險／潛勢套疊**：以 NCDR AR6 淹水災害風險作為 Primary Risk，並以水利署 24h 650mm、6h 350mm 與 24h 350mm 淹水潛勢圖作為 Comparison；其中 24h 350mm 定位為一般颱風豪雨基準，供極端情境對照
...
- **水利署 Comparison**：水利署第 3 代 24h 650mm 淹水潛勢圖呈現極端長延時廣域淹水，也是 NCDR 風險的物理基底；6h 350mm 淹水潛勢圖呈現極端短延時強降雨，可作為都市防洪壓力測試；24h 350mm 則定位為一般颱風豪雨基準，用於與極端情境對照。
- **血緣但不混算**：NCDR 的脆弱度可承接水利署 650mm 潛勢圖的淹水情況，因此兩者有資料血緣；但 NCDR 是相對風險等級，水利署是淹水深度潛勢，前端套疊時以互補解讀為主，不以兩者等級取高混算。由於淹水地理變異性大，NCDR／行政區彙整風險僅作策略層級與視覺參考，不作為點位風險套疊或未命中水利署圖資時的回退依據。
- **目前前端欄位限制**：此版本的 NCDR 淹水前端資料包提供 `flood_risk_current` 與 `flood_risk_future`，因此升溫 1.5°C／2.0°C／4.0°C 在鄉鎮彙整圖上共用未來欄位；水利署目前可用 Comparison 為 650mm/24HR、350mm/6HR 與 350mm/24HR；350mm/24HR 不作為主推極端情境，而是一般颱風豪雨基準。
